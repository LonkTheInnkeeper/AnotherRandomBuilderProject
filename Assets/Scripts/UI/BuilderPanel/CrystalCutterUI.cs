...
public class CrystalCutterUI : MonoBehaviour, IBuildableUI
{
    ...
    private void Update()
    {
        ...
        {
            available.text = "Available crystal: " + productionBuilding.available.ToString();
            storage.text = "Stored crystal: " + productionBuilding.storage.ToString() + "/" + productionBuilding.maxStorage.ToString();
